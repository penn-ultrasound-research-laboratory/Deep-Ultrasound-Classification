...
# def crop_generator(image_data_generator, batch_size, target_shape, number_crops):
...
#             batch_crops[i*number_crops:(i+1):number_crops] = sample_to_batch(
#                 images[i], 
#                 number_crops,
