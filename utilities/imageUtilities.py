...
def determine_image_type(bgr_image):
    ...
    # threshold of 0.015 was too low. Increased to 0.03. Hopefully shouldn't create false attribution. 
    # The color scale bar in true COLOR scans all but guarantees a percentage greater than 10%. 

    if 1.0 - (np.count_nonzero(equality_check) / equality_check.size) < 0.03:
